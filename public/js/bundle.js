...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiY29kZXJ3dXJzdCIsImEiOiJjazM2OWRsOGUxM2sxM2xueWJjeGkybm0wIn0.cF_HORPTV6oTnCJoflXRgg';
...
var updatePassword = function updatePassword(currentPassword, newPassword, newPasswordConfirm) {
  var result;
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        ...
        case 4:
          ...
          if (result.data.status === 'success') {
            (0, _alerts.showAlert)('success', 'password update successful');
            window.setTimeout(function () {
              location.assign('/me');
            }, 1000);
          }
...
var updateSettings = function updateSettings(name, email) {
  var result;
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        ...
        case 4:
          ...
          if (result.data.status === 'success') {
            (0, _alerts.showAlert)('success', 'update settings successful');
            window.setTimeout(function () {
              location.assign('/me');
            }, 1000);
          }
...
// DOM ELEMENTS
var accountSettingsForm = document.querySelector('.form-user-data');
...
if (logoutButton) {
  logoutButton.addEventListener('click', _logout.logout);
}
